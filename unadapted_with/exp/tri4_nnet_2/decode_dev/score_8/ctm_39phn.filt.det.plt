...
set noxtics
set noytics
set title 'DET plot for exp/tri4_nnet_2/decode_dev/score_8/ctm_39phn.filt'
set nokey
...
plot [-3.290527:3.290527] [-3.290527:3.290527] \
 'exp/tri4_nnet_2/decode_dev/score_8/ctm_39phn.filt.det.dat.00' using 2:1 title "exp/tri4_nnet_2/decode_dev/score_8/ctm_39phn" with lines
set ytics
set xtics
set size 1.0, 1.0
set key
